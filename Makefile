...
help:
	...
	@echo "  make email-help      How to run Mailpit, Resend, or Gmail SMTP"
...
email-help:
	...
	@echo ""
	@echo "   C) Gmail SMTP (real inbox, App Password)"
	@echo "      - In backend/.env set:"
	@echo "          EMAIL_BACKEND=smtp"
	@echo "          SMTP_HOST=smtp.gmail.com"
	@echo "          SMTP_PORT=465"
	@echo "          SMTP_USE_SSL=1"
	@echo "          SMTP_USER=codewithravikant@gmail.com"
	@echo "          SMTP_PASSWORD=<16-char Google App Password>"
	@echo "          SMTP_FROM=Content AI <codewithravikant@gmail.com>"
	@echo "      - Google account must have 2FA enabled + App Password created"
	@echo "      - Restart the API"
	@echo ""
	@echo "3) Run the app:  make dev"
	@echo "   The sign-in dialog explains Mailpit/Resend/Gmail behavior from your config."
	@echo ""
